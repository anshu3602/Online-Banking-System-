<html>
    ...
    <div class="ac">
    <form action="dcustomer.php" method="post">
        <div><b>Enter the Details to Delete Customer:</b></div><br>
...
{ 
	...
	{ 
        ...
        $sql3 = "delete from customer where cusid='$id' and ifsc='$ifsc'";

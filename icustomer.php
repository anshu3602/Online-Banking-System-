<html>
    ...
    <form action="icustomer.php" method="post">
     <div class="ad"><h4>Customer Details</h4><br>
         Customer ID: <input type="text" name="id" required> Password: <input type="password" name="pass" required><br><br>
        ...
        Contact: <input type="number" name="phno" required><br><br>
...
{ 
	...
	{ 
        ...
        $sql3 = "insert into customer values('$id','$fn','$ln','$em','$add','$ifsc')";    
        $sql4 = "insert into contact values('$id','$phno')";
        $sql5 = "insert into login values('$id','$pass')";

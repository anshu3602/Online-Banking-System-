<html>
    ...
    <div class="ac">
    <form action="rfund.php" method="post">
        <div><b>Enter the Details to Retrive Fund_Transfer:</b></div><br>
...
{ 
	...
	{ 
        ...
        echo "</table>";
            ...
            echo "<p style='padding:20px; border-radius:5px; margin:20px; font-size:15px;margin-right:800px; border:1px solid rgba(255,0,0,10); background-color:rgba(255,50,50,0.3); color:red;'><b>Error:</b>$tid,$id is not Exist!</p>";
        }
	} else 
	{ 

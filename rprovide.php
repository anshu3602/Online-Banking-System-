<html>
    ...
    <div class="ac">
    <form action="rcard.php" method="post">
        <div><b>Enter the Details to Retrive Provide:</b></div><br>
   Card Number: <input type="number" name="cno" placeholder="Enter the Card No" required><br><br>ID: <input type="number" name="id" placeholder="Enter the Customer ID" required><br><br>
...
{ 
	...
	if($cno!="" && $id!="")  
	{ 
        $sql1 = "select * from provide where cno='$cno' and cusid='$id'";
        ...
        echo "</table>";
            ...
            echo "<p style='padding:20px; border-radius:5px; margin:20px; font-size:15px;margin-right:800px; border:1px solid rgba(255,0,0,10); background-color:rgba(255,50,50,0.3); color:red;'><b>Error:</b>$cno is not Exist!</p>";
        }
	} else 
	{ 

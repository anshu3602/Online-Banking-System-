<html>
    ...
    <form action="rcard.php" method="post">
        <div><b>Enter the Details to Retrive Card:</b></div><br>
   Card Number: <input type="number" name="cno" placeholder="Enter the Card No" required><br><br>
...
{ 
	...
	{ 
        ...
        echo "</table>";
            ...
            echo "<p style='padding:20px; border-radius:5px; margin:20px; font-size:15px;margin-right:800px; border:1px solid rgba(255,0,0,10); background-color:rgba(255,50,50,0.3); color:red;'><b>Error:</b>$cno,$ifsc is not Exist!</p>";

<html>
    ...
    <div class="ac">
    <form action="rbank.php" method="post">
        <div><b>Enter the Details to Retrive Bank:</b></div><br>
...
{ 
	...
	if($bname!="")  
	{ 
        $sql1 = "select * from bank where bname='$bname'";
        
        $result = mysqli_query($con,$sql1);
        if(mysqli_num_rows($result)>0){
        echo "<table><tr><th>bname</th><th>bloc</th></tr>";
        while($row = mysqli_fetch_assoc($result)){
            echo "<tr><td>".$row["bname"]."</td><td>".$row["bloc"]."</td></tr>";
        }
        echo "</table>";
            ...
            echo "<p style='padding:20px; border-radius:5px; margin:20px; font-size:15px;margin-right:800px; border:1px solid rgba(255,0,0,10); background-color:rgba(255,50,50,0.3); color:red;'><b>Error:</b>$bname is not Exist!</p>";
        }
	} else 
	{ 

...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
      ...
      if(mysqli_num_rows($result)>0)
        ...
        {
             echo "<br><p style='padding:20px; border-radius:5px; margin:20px; font-size:15px;margin-right:800px; border:1px solid rgba(255,0,0,10); background-color:rgba(255,50,50,0.3); color:red;'>Table is Empty!</p>";
        } 
}
 mysqli_close($con); 
?>